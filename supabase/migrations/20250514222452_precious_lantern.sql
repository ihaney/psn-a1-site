/*
  # Fix profile creation trigger timing

  1. Changes
    - Change trigger timing to AFTER INSERT
    - Fix supplier ID handling
    - Update user profile after supplier creation
...
-- Update create_supplier_profile function
...
-- Create new trigger with AFTER INSERT timing
